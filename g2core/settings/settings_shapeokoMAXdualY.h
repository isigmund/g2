/*
 * settings_shapeokoMAXdualY.h - ShapeokoMAX  table
...
#define INIT_MESSAGE "Initializing configs to ShapeokoMAX"
...
#define M1_TRAVEL_PER_REV           48                      // 1tr
...
#define M4_TRAVEL_PER_REV           1.6
#define M4_MICROSTEPS               8
#define M4_POLARITY                 1                      // reversed plarity
...
#define X_TRAVEL_MAX                662                     // xtm  travel between switches or crashes
...
#define P1_CW_SPEED_LO          4000               // in RPM (arbitrary units)
#define P1_CW_SPEED_HI          24000
#define P1_CW_PHASE_LO          0.08               // phase [0..1]
#define P1_CW_PHASE_HI          0.5
#define P1_CCW_SPEED_LO         4000
#define P1_CCW_SPEED_HI         24000
#define P1_CCW_PHASE_LO         0.08
#define P1_CCW_PHASE_HI         0.05
